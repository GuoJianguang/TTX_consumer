...
//static float orgionWith = TWitdh*(60/750.);
{
    float orgionWith;
}
...
//    CGPathAddLineToPoint(tickPath, NULL, 39, 20);
    ...
    CGPathMoveToPoint(tickPath, NULL, orgionWith*(15/52.), orgionWith*(29/52.));
    CGPathAddLineToPoint(tickPath, NULL, orgionWith*(22/52.), orgionWith*(36/52.));
    CGPathAddLineToPoint(tickPath, NULL, orgionWith*(39/52.), orgionWith*(20/52.));
    return tickPath;
}
...
//    CGPathAddLineToPoint(tickPath, NULL, 15, 37);
    ...
    CGPathMoveToPoint(tickPath, NULL, orgionWith*(15/52.), orgionWith*(15/52.));
    CGPathAddLineToPoint(tickPath, NULL, orgionWith*(37/52.), orgionWith*(37/52.));
    CGPathMoveToPoint(tickPath, NULL, orgionWith*(37/52.), orgionWith*(15/52.));
    CGPathAddLineToPoint(tickPath, NULL, orgionWith*(15/52.), orgionWith*(37/52.));
    return tickPath;
}
