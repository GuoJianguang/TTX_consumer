...
//    
    ...
    AVCaptureVideoOrientation oritation = [[self.preview connection] videoOrientation];
    [connection setVideoOrientation:oritation];
    ...
    [self.captureOutput captureStillImageAsynchronouslyFromConnection:videoConnection completionHandler:
     ^(CMSampleBufferRef imageSampleBuffer, NSError *error) {
         ...
         t_image = [t_image fixOrientation:t_image];
...
-(void)LocalPhoto
{
    ...
    [self.delegateVC presentViewController:pickerVc animated:YES completion:nil];
//    [pickerVc show];
}
